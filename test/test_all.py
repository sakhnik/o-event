...
def test_all():
    ...
    with MockPrinter() as printer:
        ...
        receipt16 = [
            ...
            'Віктор Лисенко                                  ',
            'Ч21Е                                   1.25км 0м',
            'Вхід:  16:46:26                  Фініш: 17:19:01',
            'Старт: 16:46:26                            SI:16',
            '================================================',
            ...
            '     OK     32:35      0:04                    ',
            '================================================',
            'поточне відставання:            +0:00     хв/км',
    ...
    with MockPrinter() as printer:
        ...
        receipt149 = [
            ...
            'Юрій Поліщук                                 ZLS',
            'Ч21Е                                   1.25км 0м',
            'Вхід:  16:35:37                  Фініш: 17:10:36',
            'Старт: 16:35:37                           SI:149',
            '================================================',
            ...
            'пропуск: 74',
            'поточне відставання:            +5:03     хв/км',
            '                                          27:59',
            ''
        ]
    ...
    with MockPrinter() as printer:
        ...
        receipt32 = [
            ...
            'Артур Король                                 CPK',
            'Ч21Е                                   1.25км 0м',
            'Вхід:  16:40:25                  Фініш: 17:12:11',
            'Старт: 16:40:25                            SI:32',
            '================================================',
            ...
            '     OK     31:46      0:02                    ',
            '================================================',
            'поточне відставання:            +3:12     хв/км',
