...
def test_all():
    ...
    with MockPrinter() as printer:
        ...
        receipt16 = [
            ...
            ' 9.  57       4:39      0:43    + 0:26',
            '10.  77       4:50      0:11',
            '11.  58       5:52      1:02    + 0:51',
            '12.  79       7:41      1:49    + 0:47',
            '13.  65       8:10      0:29',
            '14.  69       8:48      0:38    + 0:09',
            '15.  55       9:08      0:20',
            '16.  52       9:14      0:06',
            '17.  63       9:48      0:34    + 0:28',
            '18.  49      10:05      0:17',
            '19.  61      10:21      0:16',
            '20.  67      11:15      0:54    + 0:38',
            '21.  71      11:58      0:43',
            '22.  78      12:11      0:13',
            '23.  64      13:15      1:04    + 0:51',
            '24.  59      13:55      0:40',
            '25.  51      14:15      0:20',
            '26.  50      14:33      0:18',
            '27.  60      14:52      0:19    + 0:01',
            '28.  42      16:55      2:03    + 1:44',
            '29.  47      18:22      1:27',
            '30.  39      19:43      1:21',
            '31.  34      20:30      0:47',
            '32.  37      21:34      1:04    + 0:17',
            '33.  35      22:29      0:55',
            '34.  45      23:55      1:26    + 0:31',
            '35.  33      26:00      2:05    + 0:39',
            '36.  36      26:21      0:21',
            '37.  32      26:43      0:22    + 0:01',
            '38.  38      27:37      0:54    + 0:32',
            '39.  48      28:25      0:48',
            '40.  44      29:42      1:17    + 0:29',
            '41.  43      30:25      0:43',
            '42.  46      30:45      0:20',
            '43.  31      31:41      0:56    + 0:36',
            '44.  40      32:01      0:20',
            '45. 100      32:31      0:30    + 0:10',
            '     OK      32:35',
            '================================================',
            'поточне відставання: —',
